...
# Description:
# ================================================================
# Time-stamp: "2022-06-02 11:36:48 trottar"
# ================================================================
#
...
H_ssxfp_DATA.Add(H_ssxfp_DATA,H_ssxfp_DATA.Scale(1.0/nWindows),1,-1)
H_ssyfp_DATA.Add(H_ssyfp_DATA,H_ssyfp_DATA.Scale(1.0/nWindows),1,-1)
H_ssxpfp_DATA.Add(H_ssxpfp_DATA,H_ssxpfp_DATA.Scale(1.0/nWindows),1,-1)
H_ssypfp_DATA.Add(H_ssypfp_DATA,H_ssypfp_DATA.Scale(1.0/nWindows),1,-1)
H_hsxfp_DATA.Add(H_hsxfp_DATA,H_hsxfp_DATA.Scale(1.0/nWindows),1,-1)
H_hsyfp_DATA.Add(H_hsyfp_DATA,H_hsyfp_DATA.Scale(1.0/nWindows),1,-1)
H_hsxpfp_DATA.Add(H_hsxpfp_DATA,H_hsxpfp_DATA.Scale(1.0/nWindows),1,-1)
H_hsypfp_DATA.Add(H_hsypfp_DATA,H_hsypfp_DATA.Scale(1.0/nWindows),1,-1)
H_ssxptar_DATA.Add(H_ssxptar_DATA,H_ssxptar_DATA.Scale(1.0/nWindows),1,-1)
H_ssyptar_DATA.Add(H_ssyptar_DATA,H_ssyptar_DATA.Scale(1.0/nWindows),1,-1)
H_hsxptar_DATA.Add(H_hsxptar_DATA,H_hsxptar_DATA.Scale(1.0/nWindows),1,-1)
H_hsyptar_DATA.Add(H_hsyptar_DATA,H_hsyptar_DATA.Scale(1.0/nWindows),1,-1)
H_ssdelta_DATA.Add(H_ssdelta_DATA,H_ssdelta_DATA.Scale(1.0/nWindows),1,-1)
H_hsdelta_DATA.Add(H_hsdelta_DATA,H_hsdelta_DATA.Scale(1.0/nWindows),1,-1)
H_Q2_DATA.Add(H_Q2_DATA,H_Q2_DATA.Scale(1.0/nWindows),1,-1)
H_epsilon_DATA.Add(H_epsilon_DATA,H_epsilon_DATA.Scale(1.0/nWindows),1,-1)
H_MMp_DATA.Add(H_MMp_DATA,H_MMp_DATA.Scale(1.0/nWindows),1,-1)
H_pmiss_DATA.Add(H_pmiss_DATA,H_pmiss_DATA.Scale(1.0/nWindows),1,-1)
H_emiss_DATA.Add(H_emiss_DATA,H_emiss_DATA.Scale(1.0/nWindows),1,-1)
H_pmx_DATA.Add(H_pmx_DATA,H_pmx_DATA.Scale(1.0/nWindows),1,-1)
H_pmy_DATA.Add(H_pmy_DATA,H_pmy_DATA.Scale(1.0/nWindows),1,-1)
H_pmz_DATA.Add(H_pmz_DATA,H_pmz_DATA.Scale(1.0/nWindows),1,-1)
H_W_DATA.Add(H_W_DATA,H_W_DATA.Scale(1.0/nWindows),1,-1)

# Dummy Random subtraction
H_ssxfp_DUMMY.Add(H_ssxfp_DUMMY,H_ssxfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssyfp_DUMMY.Add(H_ssyfp_DUMMY,H_ssyfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssxpfp_DUMMY.Add(H_ssxpfp_DUMMY,H_ssxpfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssypfp_DUMMY.Add(H_ssypfp_DUMMY,H_ssypfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsxfp_DUMMY.Add(H_hsxfp_DUMMY,H_hsxfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsyfp_DUMMY.Add(H_hsyfp_DUMMY,H_hsyfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsxpfp_DUMMY.Add(H_hsxpfp_DUMMY,H_hsxpfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsypfp_DUMMY.Add(H_hsypfp_DUMMY,H_hsypfp_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssxptar_DUMMY.Add(H_ssxptar_DUMMY,H_ssxptar_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssyptar_DUMMY.Add(H_ssyptar_DUMMY,H_ssyptar_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsxptar_DUMMY.Add(H_hsxptar_DUMMY,H_hsxptar_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsyptar_DUMMY.Add(H_hsyptar_DUMMY,H_hsyptar_DUMMY.Scale(1.0/nWindows),1,-1)
H_ssdelta_DUMMY.Add(H_ssdelta_DUMMY,H_ssdelta_DUMMY.Scale(1.0/nWindows),1,-1)
H_hsdelta_DUMMY.Add(H_hsdelta_DUMMY,H_hsdelta_DUMMY.Scale(1.0/nWindows),1,-1)
H_Q2_DUMMY.Add(H_Q2_DUMMY,H_Q2_DUMMY.Scale(1.0/nWindows),1,-1)
H_epsilon_DUMMY.Add(H_epsilon_DUMMY,H_epsilon_DUMMY.Scale(1.0/nWindows),1,-1)
H_MMp_DUMMY.Add(H_MMp_DUMMY,H_MMp_DUMMY.Scale(1.0/nWindows),1,-1)
H_pmiss_DUMMY.Add(H_pmiss_DUMMY,H_pmiss_DUMMY.Scale(1.0/nWindows),1,-1)
H_emiss_DUMMY.Add(H_emiss_DUMMY,H_emiss_DUMMY.Scale(1.0/nWindows),1,-1)
H_pmx_DUMMY.Add(H_pmx_DUMMY,H_pmx_DUMMY.Scale(1.0/nWindows),1,-1)
H_pmy_DUMMY.Add(H_pmy_DUMMY,H_pmy_DUMMY.Scale(1.0/nWindows),1,-1)
H_pmz_DUMMY.Add(H_pmz_DUMMY,H_pmz_DUMMY.Scale(1.0/nWindows),1,-1)
H_W_DUMMY.Add(H_W_DUMMY,H_W_DUMMY.Scale(1.0/nWindows),1,-1)
