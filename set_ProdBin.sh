...
if [[ $t_flag = "true" || $d_flag = "true" ]]; then
    python3 find_tBinRange.py ${KIN} ${OutDATAFilename} ${OutFullAnalysisFilename} ${NumtBins} ${data_right} ${data_left} ${data_center} ${DataChargeSumRight} ${DataChargeSumLeft} ${DataChargeSumCenter}
fi
