...
# Description:
# ================================================================
# Time-stamp: "2022-05-31 12:11:17 trottar"
# ================================================================
#
...
for i in range(nEntries_TBRANCH_DATA):
  ...
  #CUTs Definations 
  SHMS_FixCut = P_hod_goodstarttime_data = 1andP_dc_InsideDipoleExit_data = 1 # and P_hod_betanotrack_data > 0.5 and P_hod_betanotrack_data < 1.4
...
for i in range(nEntries_TBRANCH_DUMMY):
  ...
  #CUTs Definations 
  SHMS_FixCut = P_hod_goodstarttime_dummy = 1andP_dc_InsideDipoleExit_dummy = 1 # and P_hod_betanotrack_dummy > 0.5 and P_hod_betanotrack_dummy < 1.4
