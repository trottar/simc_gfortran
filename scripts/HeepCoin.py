...
# Description:
# ================================================================
# Time-stamp: "2022-06-09 01:40:16 trottar"
# ================================================================
#
...
H_ssxfp_DATA.Add(H_ssxfp_DATA.Scale(normfac_data/nWindows),-1)
H_ssyfp_DATA.Add(H_ssyfp_DATA.Scale(normfac_data/nWindows),-1)
H_ssxpfp_DATA.Add(H_ssxpfp_DATA.Scale(normfac_data/nWindows),-1)
H_ssypfp_DATA.Add(H_ssypfp_DATA.Scale(normfac_data/nWindows),-1)
H_hsxfp_DATA.Add(H_hsxfp_DATA.Scale(normfac_data/nWindows),-1)
H_hsyfp_DATA.Add(H_hsyfp_DATA.Scale(normfac_data/nWindows),-1)
H_hsxpfp_DATA.Add(H_hsxpfp_DATA.Scale(normfac_data/nWindows),-1)
H_hsypfp_DATA.Add(H_hsypfp_DATA.Scale(normfac_data/nWindows),-1)
H_ssxptar_DATA.Add(H_ssxptar_DATA.Scale(normfac_data/nWindows),-1)
H_ssyptar_DATA.Add(H_ssyptar_DATA.Scale(normfac_data/nWindows),-1)
H_hsxptar_DATA.Add(H_hsxptar_DATA.Scale(normfac_data/nWindows),-1)
H_hsyptar_DATA.Add(H_hsyptar_DATA.Scale(normfac_data/nWindows),-1)
H_ssdelta_DATA.Add(H_ssdelta_DATA.Scale(normfac_data/nWindows),-1)
H_hsdelta_DATA.Add(H_hsdelta_DATA.Scale(normfac_data/nWindows),-1)
H_Q2_DATA.Add(H_Q2_DATA.Scale(normfac_data/nWindows),-1)
H_epsilon_DATA.Add(H_epsilon_DATA.Scale(normfac_data/nWindows),-1)
H_MMp_DATA.Add(H_MMp_DATA.Scale(normfac_data/nWindows),-1)
H_pmiss_DATA.Add(H_pmiss_DATA.Scale(normfac_data/nWindows),-1)
H_emiss_DATA.Add(H_emiss_DATA.Scale(normfac_data/nWindows),-1)
H_pmx_DATA.Add(H_pmx_DATA.Scale(normfac_data/nWindows),-1)
H_pmy_DATA.Add(H_pmy_DATA.Scale(normfac_data/nWindows),-1)
H_pmz_DATA.Add(H_pmz_DATA.Scale(normfac_data/nWindows),-1)
H_W_DATA.Add(H_W_DATA.Scale(normfac_data/nWindows),-1)
H_ct_ep_DATA.Add(H_ct_ep_DATA.Scale(normfac_data/nWindows),-1)
H_ct_ep_DATA_cut.Add(H_ct_ep_DATA_cut.Scale(normfac_data/nWindows),-1)

# Dummy Random subtraction
H_ssxfp_DUMMY.Add(H_ssxfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssyfp_DUMMY.Add(H_ssyfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssxpfp_DUMMY.Add(H_ssxpfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssypfp_DUMMY.Add(H_ssypfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsxfp_DUMMY.Add(H_hsxfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsyfp_DUMMY.Add(H_hsyfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsxpfp_DUMMY.Add(H_hsxpfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsypfp_DUMMY.Add(H_hsypfp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssxptar_DUMMY.Add(H_ssxptar_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssyptar_DUMMY.Add(H_ssyptar_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsxptar_DUMMY.Add(H_hsxptar_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsyptar_DUMMY.Add(H_hsyptar_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ssdelta_DUMMY.Add(H_ssdelta_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_hsdelta_DUMMY.Add(H_hsdelta_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_Q2_DUMMY.Add(H_Q2_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_epsilon_DUMMY.Add(H_epsilon_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_MMp_DUMMY.Add(H_MMp_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_pmiss_DUMMY.Add(H_pmiss_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_emiss_DUMMY.Add(H_emiss_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_pmx_DUMMY.Add(H_pmx_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_pmy_DUMMY.Add(H_pmy_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_pmz_DUMMY.Add(H_pmz_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_W_DUMMY.Add(H_W_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ct_ep_DUMMY.Add(H_ct_ep_DUMMY.Scale(normfac_dummy/nWindows),-1)
H_ct_ep_DUMMY_cut.Add(H_ct_ep_DUMMY_cut.Scale(normfac_dummy/nWindows),-1)
