...
# RLT (2/1/2024): Testing physics_kaon again to debug 10^-6 factor
#OBJ2	= radc.o init.o dbase.o physics_kaon.o physics_pion.o physics_delta.o physics_proton.o loren.o sf_lookup.o
# RLT (9/15/2023): Replaced physics_kaon with physics_iterate
OBJ2	= radc.o init.o dbase.o physics_iterate.o physics_pion.o physics_delta.o physics_proton.o loren.o sf_lookup.o
OBJ3    = semi_physics.o rho_physics.o rho_decay.o generate_rho.o trg_track.o semi_dilution.o
OBJ4	= results_write.o event.o call_ranlux.o jacobians.o F1F2IN21_v1.0.o f1f2in21_mod.o
...
OBJF   = $(D)fdss.o
MODULES	= modules.f histograms_module.f f1f2in21_mod.f
