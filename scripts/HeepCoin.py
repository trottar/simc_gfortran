...
# Description:
# ================================================================
# Time-stamp: "2022-06-02 18:43:47 trottar"
# ================================================================
#
...
for evt in TBRANCH_DATA:
  ...
  SHMS_Acceptance = (evt.P_gtr_dp>=-10.0) & (evt.P_gtr_dp<=20.0) & (evt.P_gtr_xp>=-0.06) & (evt.P_gtr_xp<=0.06) & (evt.P_gtr_yp>=-0.04) & (evt.P_gtr_yp<=0.04)
  ...
  HMS_Acceptance = (evt.H_gtr_dp>=-8.0) & (evt.H_gtr_dp<=8.0) & (evt.H_gtr_xp>=-0.08) & (evt.H_gtr_xp<=0.08) & (evt.H_gtr_yp>=-0.045) & (evt.H_gtr_yp<=0.045)       
...
H_ssxpfp_DATA.Add(H_ssxpfp_DATA.Scale(1.0/nWindows),-1)
H_ssypfp_DATA.Add(H_ssypfp_DATA.Scale(1.0/nWindows),-1)
H_hsxfp_DATA.Add(H_hsxfp_DATA.Scale(1.0/nWindows),-1)
H_hsyfp_DATA.Add(H_hsyfp_DATA.Scale(1.0/nWindows),-1)
H_hsxpfp_DATA.Add(H_hsxpfp_DATA.Scale(1.0/nWindows),-1)
H_hsypfp_DATA.Add(H_hsypfp_DATA.Scale(1.0/nWindows),-1)
H_ssxptar_DATA.Add(H_ssxptar_DATA.Scale(1.0/nWindows),-1)
H_ssyptar_DATA.Add(H_ssyptar_DATA.Scale(1.0/nWindows),-1)
H_hsxptar_DATA.Add(H_hsxptar_DATA.Scale(1.0/nWindows),-1)
H_hsyptar_DATA.Add(H_hsyptar_DATA.Scale(1.0/nWindows),-1)
H_ssdelta_DATA.Add(H_ssdelta_DATA.Scale(1.0/nWindows),-1)
H_hsdelta_DATA.Add(H_hsdelta_DATA.Scale(1.0/nWindows),-1)
H_Q2_DATA.Add(H_Q2_DATA.Scale(1.0/nWindows),-1)
H_epsilon_DATA.Add(H_epsilon_DATA.Scale(1.0/nWindows),-1)
H_MMp_DATA.Add(H_MMp_DATA.Scale(1.0/nWindows),-1)
H_pmiss_DATA.Add(H_pmiss_DATA.Scale(1.0/nWindows),-1)
H_emiss_DATA.Add(H_emiss_DATA.Scale(1.0/nWindows),-1)
H_pmx_DATA.Add(H_pmx_DATA.Scale(1.0/nWindows),-1)
...
H_ssyfp_DUMMY.Add(H_ssyfp_DUMMY.Scale(1.0/nWindows),-1)
H_ssxpfp_DUMMY.Add(H_ssxpfp_DUMMY.Scale(1.0/nWindows),-1)
H_ssypfp_DUMMY.Add(H_ssypfp_DUMMY.Scale(1.0/nWindows),-1)
H_hsxfp_DUMMY.Add(H_hsxfp_DUMMY.Scale(1.0/nWindows),-1)
H_hsyfp_DUMMY.Add(H_hsyfp_DUMMY.Scale(1.0/nWindows),-1)
H_hsxpfp_DUMMY.Add(H_hsxpfp_DUMMY.Scale(1.0/nWindows),-1)
H_hsypfp_DUMMY.Add(H_hsypfp_DUMMY.Scale(1.0/nWindows),-1)
H_ssxptar_DUMMY.Add(H_ssxptar_DUMMY.Scale(1.0/nWindows),-1)
H_ssyptar_DUMMY.Add(H_ssyptar_DUMMY.Scale(1.0/nWindows),-1)
H_hsxptar_DUMMY.Add(H_hsxptar_DUMMY.Scale(1.0/nWindows),-1)
H_hsyptar_DUMMY.Add(H_hsyptar_DUMMY.Scale(1.0/nWindows),-1)
H_ssdelta_DUMMY.Add(H_ssdelta_DUMMY.Scale(1.0/nWindows),-1)
H_hsdelta_DUMMY.Add(H_hsdelta_DUMMY.Scale(1.0/nWindows),-1)
H_Q2_DUMMY.Add(H_Q2_DUMMY.Scale(1.0/nWindows),-1)
H_epsilon_DUMMY.Add(H_epsilon_DUMMY.Scale(1.0/nWindows),-1)
H_MMp_DUMMY.Add(H_MMp_DUMMY.Scale(1.0/nWindows),-1)
H_pmiss_DUMMY.Add(H_pmiss_DUMMY.Scale(1.0/nWindows),-1)
H_emiss_DUMMY.Add(H_emiss_DUMMY.Scale(1.0/nWindows),-1)
H_pmx_DUMMY.Add(H_pmx_DUMMY.Scale(1.0/nWindows),-1)
