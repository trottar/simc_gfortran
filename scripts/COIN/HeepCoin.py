...
# Description:
# ================================================================
# Time-stamp: "2022-09-26 17:07:41 trottar"
# ================================================================
#
...
for evt in TBRANCH_DATA:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DATA.SetBinError(ibin,eff_errProp_data)
      
      H_ssxfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssyfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssxpfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssypfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssdelta_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssxptar_DATA.SetBinError(ibin,eff_errProp_data)
      H_ssyptar_DATA.SetBinError(ibin,eff_errProp_data)
      
      H_hsxfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsyfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsxpfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsypfp_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsdelta_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsxptar_DATA.SetBinError(ibin,eff_errProp_data)
      H_hsyptar_DATA.SetBinError(ibin,eff_errProp_data)

      H_ph_q_DATA.SetBinError(ibin,eff_errProp_data)
      H_th_q_DATA.SetBinError(ibin,eff_errProp_data)
      H_ph_recoil_DATA.SetBinError(ibin,eff_errProp_data)
      H_th_recoil_DATA.SetBinError(ibin,eff_errProp_data)
      
      H_pmiss_DATA.SetBinError(ibin,eff_errProp_data)
      H_emiss_DATA.SetBinError(ibin,eff_errProp_data)
      #H_emiss_DATA.SetBinError(ibin,eff_errProp_data)
      H_pmx_DATA.SetBinError(ibin,eff_errProp_data)
      H_pmy_DATA.SetBinError(ibin,eff_errProp_data)
      H_pmz_DATA.SetBinError(ibin,eff_errProp_data)
      H_Q2_DATA.SetBinError(ibin,eff_errProp_data)
      H_W_DATA.SetBinError(ibin,eff_errProp_data)
      H_epsilon_DATA.SetBinError(ibin,eff_errProp_data)
      H_MMp2_DATA.SetBinError(ibin,eff_errProp_data)
      #H_MMp2_DATA.SetBinError(ibin,eff_errProp_data)
      #H_MMp2_DATA.SetBinError(ibin,eff_errProp_data)

      H_cal_etottracknorm_DATA.SetBinError(ibin,eff_errProp_data)
      H_cer_npeSum_DATA.SetBinError(ibin,eff_errProp_data)

      P_cal_etottracknorm_DATA.SetBinError(ibin,eff_errProp_data)
      P_hgcer_npeSum_DATA.SetBinError(ibin,eff_errProp_data)
      P_aero_npeSum_DATA.SetBinError(ibin,eff_errProp_data)
...
for evt in TBRANCH_DATA_nocut:
  ...
  H_ct_ep_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  H_ssxfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssyfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssxpfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssypfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssdelta_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssxptar_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ssyptar_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  H_hsxfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsyfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsxpfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsypfp_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsdelta_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsxptar_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_hsyptar_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  H_ph_q_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_th_q_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_ph_recoil_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_th_recoil_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  H_pmiss_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_emiss_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  #H_emiss_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_pmx_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_pmy_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_pmz_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_Q2_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_W_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_epsilon_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  #H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  #H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  H_cal_etottracknorm_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  H_cer_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp_data)

  P_cal_etottracknorm_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  P_hgcer_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp_data)
  P_aero_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp_data)
...
for evt in TBRANCH_DATA_nopid:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      
      H_ssxfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssyfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssxpfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssypfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssdelta_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssxptar_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ssyptar_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      
      H_hsxfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsyfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsxpfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsypfp_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsdelta_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsxptar_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_hsyptar_DATA_nopid.SetBinError(ibin,eff_errProp_data)

      H_ph_q_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_th_q_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_ph_recoil_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_th_recoil_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      
      H_pmiss_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_emiss_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      #H_emiss_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_pmx_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_pmy_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_pmz_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_Q2_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_W_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_epsilon_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      #H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      #H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp_data)

      H_cal_etottracknorm_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      H_cer_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp_data)

      P_cal_etottracknorm_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      P_hgcer_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp_data)
      P_aero_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp_data)
...
for evt in TBRANCH_DUMMY:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      
      H_ssxfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssyfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssxpfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssypfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssdelta_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssxptar_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ssyptar_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      
      H_hsxfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsyfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsxpfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsypfp_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsdelta_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsxptar_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_hsyptar_DUMMY.SetBinError(ibin,eff_errProp_dummy)

      H_ph_q_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_th_q_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_ph_recoil_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_th_recoil_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      
      H_pmiss_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_emiss_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      #H_emiss_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_pmx_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_pmy_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_pmz_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_Q2_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_W_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_epsilon_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      H_MMp2_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      #H_MMp2_DUMMY.SetBinError(ibin,eff_errProp_dummy)
      #H_MMp2_DUMMY.SetBinError(ibin,eff_errProp_dummy)
...
for evt in TBRANCH_DUMMY_nocut:
  ...
  H_ct_ep_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)

  H_ssxfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssyfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssxpfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssypfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssdelta_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssxptar_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ssyptar_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)

  H_hsxfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsyfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsxpfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsypfp_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsdelta_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsxptar_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_hsyptar_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)

  H_ph_q_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_th_q_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_ph_recoil_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_th_recoil_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)

  H_pmiss_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_emiss_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  #H_emiss_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_pmx_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_pmy_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_pmz_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_Q2_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_W_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_epsilon_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  #H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
  #H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp_dummy)
...
for evt in TBRANCH_DUMMY_nopid:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      
      H_ssxfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssyfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssxpfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssypfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssdelta_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssxptar_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ssyptar_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      
      H_hsxfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsyfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsxpfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsypfp_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsdelta_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsxptar_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_hsyptar_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)

      H_ph_q_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_th_q_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_ph_recoil_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_th_recoil_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      
      H_pmiss_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_emiss_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      #H_emiss_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_pmx_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_pmy_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_pmz_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_Q2_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_W_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_epsilon_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      #H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
      #H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp_dummy)
