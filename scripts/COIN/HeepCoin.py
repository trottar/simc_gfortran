...
# Description:
# ================================================================
# Time-stamp: "2022-09-26 16:05:26 trottar"
# ================================================================
#
...
for evt in TBRANCH_DATA:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DATA.SetBinError(ibin,eff_errProp)
      
      H_ssxfp_DATA.SetBinError(ibin,eff_errProp)
      H_ssyfp_DATA.SetBinError(ibin,eff_errProp)
      H_ssxpfp_DATA.SetBinError(ibin,eff_errProp)
      H_ssypfp_DATA.SetBinError(ibin,eff_errProp)
      H_ssdelta_DATA.SetBinError(ibin,eff_errProp)
      H_ssxptar_DATA.SetBinError(ibin,eff_errProp)
      H_ssyptar_DATA.SetBinError(ibin,eff_errProp)
      
      H_hsxfp_DATA.SetBinError(ibin,eff_errProp)
      H_hsyfp_DATA.SetBinError(ibin,eff_errProp)
      H_hsxpfp_DATA.SetBinError(ibin,eff_errProp)
      H_hsypfp_DATA.SetBinError(ibin,eff_errProp)
      H_hsdelta_DATA.SetBinError(ibin,eff_errProp)
      H_hsxptar_DATA.SetBinError(ibin,eff_errProp)
      H_hsyptar_DATA.SetBinError(ibin,eff_errProp)

      H_ph_q_DATA.SetBinError(ibin,eff_errProp)
      H_th_q_DATA.SetBinError(ibin,eff_errProp)
      H_ph_recoil_DATA.SetBinError(ibin,eff_errProp)
      H_th_recoil_DATA.SetBinError(ibin,eff_errProp)
      
      H_pmiss_DATA.SetBinError(ibin,eff_errProp)
      H_emiss_DATA.SetBinError(ibin,eff_errProp)
      #H_emiss_DATA.SetBinError(ibin,eff_errProp)
      H_pmx_DATA.SetBinError(ibin,eff_errProp)
      ...
      H_cal_etottracknorm_DATA.SetBinError(ibin,eff_errProp)
      H_cer_npeSum_DATA.SetBinError(ibin,eff_errProp)

      P_cal_etottracknorm_DATA.SetBinError(ibin,eff_errProp)
      P_hgcer_npeSum_DATA.SetBinError(ibin,eff_errProp)
      P_aero_npeSum_DATA.SetBinError(ibin,eff_errProp)
...
for evt in TBRANCH_DATA_nocut:
  ...
  H_ct_ep_DATA_nocut.SetBinError(ibin,eff_errProp)

  H_ssxfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssyfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssxpfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssypfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssdelta_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssxptar_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ssyptar_DATA_nocut.SetBinError(ibin,eff_errProp)

  H_hsxfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsyfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsxpfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsypfp_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsdelta_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsxptar_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_hsyptar_DATA_nocut.SetBinError(ibin,eff_errProp)

  H_ph_q_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_th_q_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_ph_recoil_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_th_recoil_DATA_nocut.SetBinError(ibin,eff_errProp)

  H_pmiss_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_emiss_DATA_nocut.SetBinError(ibin,eff_errProp)
  #H_emiss_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_pmx_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_pmy_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_pmz_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_Q2_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_W_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_epsilon_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp)
  #H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp)
  #H_MMp2_DATA_nocut.SetBinError(ibin,eff_errProp)

  H_cal_etottracknorm_DATA_nocut.SetBinError(ibin,eff_errProp)
  H_cer_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp)

  P_cal_etottracknorm_DATA_nocut.SetBinError(ibin,eff_errProp)
  P_hgcer_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp)
  P_aero_npeSum_DATA_nocut.SetBinError(ibin,eff_errProp)
...
for evt in TBRANCH_DATA_nopid:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DATA_nopid.SetBinError(ibin,eff_errProp)
      
      H_ssxfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssyfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssxpfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssypfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssdelta_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssxptar_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ssyptar_DATA_nopid.SetBinError(ibin,eff_errProp)
      
      H_hsxfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsyfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsxpfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsypfp_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsdelta_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsxptar_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_hsyptar_DATA_nopid.SetBinError(ibin,eff_errProp)

      H_ph_q_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_th_q_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_ph_recoil_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_th_recoil_DATA_nopid.SetBinError(ibin,eff_errProp)
      
      H_pmiss_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_emiss_DATA_nopid.SetBinError(ibin,eff_errProp)
      #H_emiss_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_pmx_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_pmy_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_pmz_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_Q2_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_W_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_epsilon_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp)
      #H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp)
      #H_MMp2_DATA_nopid.SetBinError(ibin,eff_errProp)

      H_cal_etottracknorm_DATA_nopid.SetBinError(ibin,eff_errProp)
      H_cer_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp)

      P_cal_etottracknorm_DATA_nopid.SetBinError(ibin,eff_errProp)
      P_hgcer_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp)
      P_aero_npeSum_DATA_nopid.SetBinError(ibin,eff_errProp)
...
for evt in TBRANCH_DUMMY:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DUMMY.SetBinError(ibin,eff_errProp)
      
      H_ssxfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssyfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssxpfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssypfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssdelta_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssxptar_DUMMY.SetBinError(ibin,eff_errProp)
      H_ssyptar_DUMMY.SetBinError(ibin,eff_errProp)
      
      H_hsxfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsyfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsxpfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsypfp_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsdelta_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsxptar_DUMMY.SetBinError(ibin,eff_errProp)
      H_hsyptar_DUMMY.SetBinError(ibin,eff_errProp)

      H_ph_q_DUMMY.SetBinError(ibin,eff_errProp)
      H_th_q_DUMMY.SetBinError(ibin,eff_errProp)
      H_ph_recoil_DUMMY.SetBinError(ibin,eff_errProp)
      H_th_recoil_DUMMY.SetBinError(ibin,eff_errProp)
      
      H_pmiss_DUMMY.SetBinError(ibin,eff_errProp)
      H_emiss_DUMMY.SetBinError(ibin,eff_errProp)
      #H_emiss_DUMMY.SetBinError(ibin,eff_errProp)
      H_pmx_DUMMY.SetBinError(ibin,eff_errProp)
      H_pmy_DUMMY.SetBinError(ibin,eff_errProp)
      H_pmz_DUMMY.SetBinError(ibin,eff_errProp)
      H_Q2_DUMMY.SetBinError(ibin,eff_errProp)
      H_W_DUMMY.SetBinError(ibin,eff_errProp)
      H_epsilon_DUMMY.SetBinError(ibin,eff_errProp)
      H_MMp2_DUMMY.SetBinError(ibin,eff_errProp)
      #H_MMp2_DUMMY.SetBinError(ibin,eff_errProp)
      #H_MMp2_DUMMY.SetBinError(ibin,eff_errProp)
...
for evt in TBRANCH_DUMMY_nocut:
  ...
  H_ct_ep_DUMMY_nocut.SetBinError(ibin,eff_errProp)

  H_ssxfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssyfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssxpfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssypfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssdelta_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssxptar_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ssyptar_DUMMY_nocut.SetBinError(ibin,eff_errProp)

  H_hsxfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsyfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsxpfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsypfp_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsdelta_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsxptar_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_hsyptar_DUMMY_nocut.SetBinError(ibin,eff_errProp)

  H_ph_q_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_th_q_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_ph_recoil_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_th_recoil_DUMMY_nocut.SetBinError(ibin,eff_errProp)

  H_pmiss_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_emiss_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  #H_emiss_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_pmx_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_pmy_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_pmz_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_Q2_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_W_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_epsilon_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  #H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp)
  #H_MMp2_DUMMY_nocut.SetBinError(ibin,eff_errProp)
...
for evt in TBRANCH_DUMMY_nopid:
  ...
  if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance):
      ...
      H_ct_ep_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      
      H_ssxfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssyfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssxpfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssypfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssdelta_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssxptar_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ssyptar_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      
      H_hsxfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsyfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsxpfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsypfp_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsdelta_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsxptar_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_hsyptar_DUMMY_nopid.SetBinError(ibin,eff_errProp)

      H_ph_q_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_th_q_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_ph_recoil_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_th_recoil_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      
      H_pmiss_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_emiss_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      #H_emiss_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_pmx_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_pmy_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_pmz_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_Q2_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_W_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_epsilon_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      #H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp)
      #H_MMp2_DUMMY_nopid.SetBinError(ibin,eff_errProp)
