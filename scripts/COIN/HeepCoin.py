...
from ROOT import kBlack, kCyan, kRed, kGreen
...
c_pid = TCanvas()
l_pid = ROOT.TLegend(0.115,0.735,0.33,0.9)
...
Cph_q = TCanvas()
l_ph_q = ROOT.TLegend(0.115,0.735,0.33,0.9)
...
Cth_q = TCanvas()
l_th_q = ROOT.TLegend(0.115,0.735,0.33,0.9)
