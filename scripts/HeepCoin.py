...
# Description:
# ================================================================
# Time-stamp: "2022-05-31 17:53:43 trottar"
# ================================================================
#
...
xfp = TCanvas()
l_xfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
yfp = TCanvas()
l_yfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
xpfp = TCanvas()
l_xpfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
ypfp = TCanvas()
l_ypfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hxfp = TCanvas()
l_hxfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hyfp = TCanvas()
l_hyfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hxpfp = TCanvas()
l_hxpfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hypfp = TCanvas()
l_hypfp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
xptar = TCanvas()
l_xptar = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
yptar = TCanvas()
l_yptar = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hxptar = TCanvas()
l_hxptar = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hyptar = TCanvas()
l_hyptar = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Delta = TCanvas()
l_Delta = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
hDelta = TCanvas()
l_hDelta = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
CQ2 = TCanvas()
l_Q2 = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cepsilon = TCanvas()
l_epsilon = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
CMMp = TCanvas()
l_MMp = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cpmiss = TCanvas()
l_pmiss = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cemiss = TCanvas()
l_emiss = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cpmiss_x = TCanvas()
l_pmx = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cpmiss_y = TCanvas()
l_pmy = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
Cpmiss_z = TCanvas()
l_pmz = ROOT.TLegend(0.115,0.635,0.23,0.9)
...
CW = TCanvas()
l_W = ROOT.TLegend(0.115,0.635,0.23,0.9)
